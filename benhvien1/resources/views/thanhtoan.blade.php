...
<section class="contact-section">
    <div class="container">
        <div class="row">
            ...
            <i class="fas fa-user"></i><h5>Bệnh nhân&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{($value->TenBN)}}</h5>
            <i class="fas fa-phone"></i><h5>Số điện thoại&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{($value->DienThoai)}}</h5>
            
            @endforeach
            @foreach($result as $key =>$values)
            <i class="far fa-address-card"></i><h5>Chuyên khoa&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{($values->TenKhoa)}}</h5>
            <i class="fas fa-user-md"></i><h5>Bác sĩ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{($values->TenBS)}}</h5>
            <i class="fas fa-calendar-alt"></i><h5>Thời gian&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{($values->NgayTruc)}}({{($values->Buoi)}})</h5>
            <i class="fas fa-hospital"></i><h5>Phòng&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{($values->MaPhong)}}</h5>
            <hr>
